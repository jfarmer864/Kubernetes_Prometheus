...
Vagrant.configure("2") do |config|
  ...
  config.vm.define "Kube-master" do |master|
    ...
    master.vm.network "public_network", ip: "192.168.10.105"
    master.vm.synced_folder "./Playbooks", "/home/ubuntu/Playbooks"
    master.vm.synced_folder "./prometheus", "/home/ubuntu/prometheus"
    master.vm.synced_folder "./metrics", "/home/ubuntu/metrics"
  ...
  (1..N).each do |i|
    config.vm.define "node-#{i}" do |node|
      ...
      node.vm.network "public_network", ip: "192.168.10.#{105 + i}"
